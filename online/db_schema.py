...
companies = Table(
    ...
    Column("contact_email", String(320), nullable=False, server_default=""),
    Column("phone", String(80), nullable=False, server_default=""),
    Column("active", Integer, nullable=False, server_default="1"),
    Column("created_at", String(40), nullable=False),
)
Index("uq_companies_name_ci", func.lower(companies.c.name), unique=True)
...
users = Table(
    ...
    Column("created_at", String(40), nullable=False),
    CheckConstraint(
        "role IN ('supervisor','operator','customer')",
        name="ck_users_role",
    ),
)
...
sessions = Table(
    ...
    Column("acting_company_id", Integer, ForeignKey("companies.id")),

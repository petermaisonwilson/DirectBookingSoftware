...
def register_web_v1_routes(app) -> None:
    ...
    def operations_home(request: Request):
        ...
        <div class="grid">
          <div class="card"><h2>Availability Calendar</h2><p>See free, booked, closed and temporarily held Elements by date.</p><p><a class="button" href="/availability/calendar">Open Availability Calendar</a> <a class="button secondary" href="/company/hold-settings">Hold timing</a></p></div>
          <div class="card"><h2>Customers</h2><p><strong>{counts['customer_records']}</strong> customer record(s)</p><p><a class="button" href="/operations/customers">Open Client Register</a></p></div>

...
def main() -> None:
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        # New catalogue rows were inserted after register_web_v1, so initialise defaults for this test data.
        ...
        assert 'Add-on Timings &amp; Person Pricing' in setup_page.text
        ...
        # Element 100 + people 52 + breakfast ((2x10)+(1x6)) x 4 = 104 => 256.
        ...
        # Base 152 + selected breakfasts 26 + 16 = 194.
        ...
        assert f'name="addon_day_person_{breakfast_id}_{adult_id}_'+"'" not in edit.text  # generated by JS at runtime

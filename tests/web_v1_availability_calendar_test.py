...
def main() -> None:
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        with db.connect() as c:
            # Blank-year Setup needs an operating window for availability.
        ...
        # Closure renders on the correct fixed date columns with no shifted duplicate cells.
        ...
        with db.connect() as c:
            ...
            # A newly saved Enquiry is automatically given the Held status and a ten-minute expiry.
        ...
        # Every rendered day cell has an explicit grid column; this is the regression for the shifted grey-cell bug.
        ...
        # The live Enquiry blocks Pitch 2 until its expiry.
        ...
        # Client edits a status colour, then changes the booking to it; calendar immediately reflects both.
        ...
        # A client-defined non-blocking Released status returns the Element to availability.
        ...
        # Customer sees occupancy only, never another customer's identity/reference/status detail.
        ...
        # Setup and audit trail cover status configuration and booking status changes.
    ...
    print('Direct Booking Web V1 status-aware Availability Calendar test: passed')
